            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div>
                ...
                <ul className="text-sm text-gray-600 space-y-2">
                  ...
                  <li><a href="#" className="hover:text-blue-600">Order and pick up</a></li>
                  <li><a href="#" className="hover:text-blue-600">Delivery</a></li>
                  <li><a href="#" className="hover:text-blue-600">Shopping over the phone</a></li>
              ...
              <div>
                ...
                <ul className="text-sm text-gray-600 space-y-2">
                  ...
                  <li><a href="#" className="hover:text-blue-600">Online help</a></li>
                  <li><a href="#" className="hover:text-blue-600">Our stores</a></li>
              ...
              <div>
                ...
                <ul className="text-sm text-gray-600 space-y-2">
                  <li><a href="#" className="hover:text-blue-600">Transport</a></li>
                  <li><a href="#" className="hover:text-blue-600">Repair service</a></li>
                  <li><a href="#" className="hover:text-blue-600">Best personal advice service</a></li>
                  <li><a href="#" className="hover:text-blue-600">Recycling and disposal service</a></li>
                  <li><a href="#" className="hover:text-blue-600">Dismantling and assembly</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="text-sm text-gray-600 space-y-2">
                  ...
                  <li><a href="#" className="hover:text-blue-600">Regulations</a></li>
                  <li><a href="#" className="hover:text-blue-600">Privacy Policy</a></li>
                  <li><a href="#" className="hover:text-blue-600">Terms and Conditions</a></li>
                  <li><a href="#" className="hover:text-blue-600">Return of used equipment</a></li>
                  <li><a href="#" className="hover:text-blue-600">Personal Data Request</a></li>
                </ul>
              </div>
            </div>
          </div>          
