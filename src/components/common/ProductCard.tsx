...
export const ProductCard: React.FC<ProductCardProps> = ({
    ...
    const handleUpdateCart = () => {
        ...
        const quantity = Number((document.querySelector(`#qty-${partNo}`) as HTMLInputElement | null)?.value || 1);
        ...
        <article className="w-full text-sm leading-6 group hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="relative w-full aspect-[1.224]">
                    ...
                    {inStock ? (
                        <div className="absolute bottom-2 left-2 z-10 flex items-center gap-1 px-3 py-1 text-xs text-green-700 bg-white/70 backdrop-blur-sm rounded">
                            <img src="/products/instock.png" alt="In stock" className="object-contain w-4 h-4" />
                            <p>Còn hàng</p>
                        </div>
                    ) : (
            ...
            {showAddedMessage && (
                <div className="flex gap-2 justify-center px-16 py-2 text-blue-600 bg-sky-100 max-md:px-5">
                    <img src="/products/added.png" alt="Success" className="w-4 aspect-square" />
